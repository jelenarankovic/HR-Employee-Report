#Gender breakdown of employees in the company
	#Here we are looking at people older or that are 18 years old
    #and who are employed in the company 
SELECT gender, count(*) AS count
FROM hr
WHERE age>=18 AND termdate = '0000-00-00'
GROUP BY gender;

#Ethnicity breakdown SELECT gender, count(*) AS count
...
#Gender distribution among the age groups
...
#Work location distribution(office vs remote)
...
#Tenure disttribution for each department
